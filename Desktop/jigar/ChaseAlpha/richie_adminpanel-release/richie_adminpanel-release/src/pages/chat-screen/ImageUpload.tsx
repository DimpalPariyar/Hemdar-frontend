...
export default function ImageUpload({ name, formik }: any) {
  ...
  return (
    <Box display="flex" mt={2} flexDirection="column">
      <Box width={450} onPaste={handlePaste} style={{ border: '1px dashed #2D00D2', borderRadius: 12,height:'35px' }}>
        <Box m={1} borderRadius={1} {...getRootProps()}>
          <input {...getInputProps()} />
          <Typography sx={{ cursor: 'pointer',color:'#B6B6B6'}}>
